import{g as T,b as U,k,s as y,_ as h,c as B,d as f,r as x,e as A,f as F,j as t,h as L,i as P,B as R,S as c,T as l,G as r,M as W,P as X}from"./index-Do07BApl.js";function E(a){return String(a).match(/[\d.\-+]*\s*(.*)/)[1]||""}function N(a){return parseFloat(a)}function G(a){return T("MuiSkeleton",a)}U("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const K=["animation","className","component","height","style","variant","width"];let p=a=>a,v,w,b,C;const O=a=>{const{classes:i,variant:n,animation:s,hasChildren:o,width:u,height:d}=a;return P({root:["root",n,s,o&&"withChildren",o&&!u&&"fitContent",o&&!d&&"heightAuto"]},G,i)},V=k(v||(v=p`
  0% {
    opacity: 1;
  }
